...
class Gallery extends React.Component {
  constructor (props) {
    ...
    this.gotoImage = this.props.isOpen;
...
getOnClickThumbnailFn () {
  if(!this.props.onClickThumbnail && this.propsEnableLightbox)
...
render() {
  var images = this.state.thumbnails.map((item, idx) => {
    ...
    isSelectable={this.props.enableImageSelector}
